...
/*************************************************************************
Function: uart_putsubaru()
Purpose:  transmit Subaru Query to UART
Input:    query to be transmitted
Returns:  none
**************************************************************************/
void uart_putsubaru(const char *s )
{
	int i;
	for(i=0; i<4; i++) {
		uart_putc(*s++);
...
void uart1_init(unsigned int baudrate)
{
    ...
    #ifdef URSEL1
    UCSR1C = (1<<URSEL1)|(3<<UCSZ10)|(2<<UPM10);
    #else
...
/*************************************************************************
Function: uart1_putsubaru()
Purpose:  transmit Subaru Query to UART1
Input:    query to be transmitted
Returns:  none
**************************************************************************/
void uart1_putsubaru(const char *s )
{
	int i;
	for(i=0; i<4; i++) {
		uart1_putc(*s++);
